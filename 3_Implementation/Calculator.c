      ...
      switch(operator2)
        {
          case 1:
            ...
            scanf("%f %c %f", &valueOne, &operator2, & valueTwo); 
            int v1 = (int)valueOne;
            int v2 = (int)valueTwo;
            int max = (v1 > v2) ? v1 : v2;
            while (1) {
          ...
          case 8:
            ...
            printf("Result of Combination is %.1f: ", ncr);
            break;
          default:
            printf("Fail");
        }
    ...
    case 3:
      ...
      switch(operator3)
      {
        ...
        case 4:
          ...
          printf("Cosec value is %.2f", cosecval);
          break;
        case 5:
